...
{
    public class BaseFormWithTopMost : Form
    {
        ...
        private void BuildTitleBar()
        {
            ...
            titleBar.BackColor = Color.FromArgb(45, 45, 48);
        ...
        private void BuildButtons()
        {
            ...
            //foreach (var name in typeof(BaseFormWithTopMost).Assembly.GetManifestResourceNames())
            //{
