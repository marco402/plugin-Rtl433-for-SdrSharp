...
Version 1.11  May 2021
    ...
    - In FSK, the pulse data curve was not displayed.  
    - Fix to be able to replay the files generated by one shoot record(the 50000 samples to decrease
      cycle time was not sufficient also recording the last five buffer.  
...
Version 1.11  Mai 2021
    ...
    - En FSK, la courbe pulse data ne s'affichait pas.  
    -Correctif pour pouvoir rejouer les fichiers générés par one shoot record(les 50000 échantillons pour diminuer
      le temps de cycle ne suffisaient pas aussi enregistrement des 5 derniers buffer.  
